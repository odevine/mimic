...
func TestRegisterAndGet(t *testing.T) {
	Register("fake-get", func() Template { return fakeTemplate{name: "fake-get"} })
...
func TestGetReturnsFreshInstance(t *testing.T) {
	...
	Register("fake-fresh", func() Template { return &fakeTemplate{name: "fake-fresh"} })
	a, _ := Get("fake-fresh")
	b, _ := Get("fake-fresh")
	if a == b {
...
func TestNamesSorted(t *testing.T) {
	Register("fake-zeta", func() Template { return fakeTemplate{name: "fake-zeta"} })
	Register("fake-alpha", func() Template { return fakeTemplate{name: "fake-alpha"} })
...
func TestRegisterDuplicatePanics(t *testing.T) {
	...
	Register("fake-dup", func() Template { return fakeTemplate{name: "fake-dup"} })
	Register("fake-dup", func() Template { return fakeTemplate{name: "fake-dup"} })
}
